...
-- receive  try      when
@keywords = after|apply|attributes|call|case|catch|do|end|fun|in|let|letrec|module|of|primop|receive|try|when
...
tokens :-
  ...
  \'(($inputchar # [$control \\ \'])|@escape)*\'    { \s -> TAtom $ atomDropQupte $ readEscape s}
