...
is_prefix_op(strict) ->
    set;
is_prefix_op(components) ->
    graph;
is_prefix_op(condensation) ->
    graph;
is_prefix_op(closure) ->
    graph;
is_prefix_op('#') ->
    numeric;
is_prefix_op(_) ->
...
regexp(Kind,RExpr,Type) ->
    ...
    case Type of
        ...
        'Rel'
            ...
            E;
        _Else->
            return_error(0,["type_mismatch", t2s(E)])
    end.
...
return_error(Line,Message) ->
    throw({error,{Line,xref_parser,Message}}).
...
yeccpars0(Tokens,Tzr,State,States,Vstack) ->
    try yeccpars1(Tokens,Tzr,State,States,Vstack)
            ...
            throw:{error,{_Line,xref_parser,_M}} = Error->
                Error end.

yecc_error_type(function_clause,[{xref_parser,F,ArityOrArgs,_}| _]) ->
...
yeccerror(Token) ->
    ...
    {error,{Location,xref_parser,["syntax error before: ", Text]}}.
...
'yeccpars2_2_\\\'$end\\\''(__Stack0) ->
    ...
    [begin {variable,__1} end| __Stack].
...
yeccpars2_2_(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin check_regexp_variable(__1) end| __Stack].
...
'yeccpars2_10_\\\'$end\\\''(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin {constant,unknown,vertex,__1} end| __Stack].
...
yeccpars2_19_(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin value_of(__1) end| __Stack].
...
yeccpars2_21_(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin check_regexp(value_of(__1)) end| __Stack].
...
yeccpars2_32_(__Stack0) ->
    ...
    [begin type({tuple,[__2| __3]},__5) end| __Stack].
...
yeccpars2_37_(__Stack0) ->
    [__5, __4, __3, __2, __1| __Stack] = __Stack0,
    [begin type({list,[__2| __3]},__5) end| __Stack].
...
yeccpars2_41_(__Stack0) ->
    [__3, __2, __1| __Stack] = __Stack0,
    [begin value_of(__2) end| __Stack].
...
yeccpars2_47_(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin intersection end| __Stack].
...
yeccpars2_54_(__Stack0) ->
    [__3, __2, __1| __Stack] = __Stack0,
    [begin {set,__2,__1,__3} end| __Stack].
...
yeccpars2_56_(__Stack0) ->
    [__3, __2, __1| __Stack] = __Stack0,
    [begin {path,__1,__3} end| __Stack].
...
yeccpars2_57_(__Stack0) ->
    [__3, __2, __1| __Stack] = __Stack0,
    [begin {restr,__2,__1,__3} end| __Stack].
...
yeccpars2_58_(__Stack0) ->
    ...
    [begin {type,{convert,__1},__2} end| __Stack].
...
yeccpars2_59_(__Stack0) ->
    [__2, __1| __Stack] = __Stack0,
    [begin type(__1,__2) end| __Stack].
...
yeccpars2_60_(__Stack0) ->
    [__2, __1| __Stack] = __Stack0,
    [begin prefix(__1,__2) end| __Stack].
...
yeccpars2_71_(__Stack0) ->
    [__1| __Stack] = __Stack0,
    [begin {integer,value_of(__1)} end| __Stack].
...
yeccpars2_72_(__Stack0) ->
    ...
    [begin regexp(func,{__1,__3,__5},__6) end| __Stack].
...
yeccpars2_73_(__Stack0) ->
    [__2, __1| __Stack] = __Stack0,
    [begin regexp(atom,__1,__2) end| __Stack].
...
yeccpars2_79_(__Stack0) ->
    [__3, __2, __1| __Stack] = __Stack0,
    [begin {assign,__2,__1,__3} end| __Stack].
