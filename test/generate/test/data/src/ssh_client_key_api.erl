...
-file("ssh_client_key_api.erl", 24).
...
-file("ssh_client_key_api.erl", 25).
...
-optional_callbacks([is_host_key/4, is_host_key/5]).
...
-optional_callbacks([add_host_key/3, add_host_key/4]).
