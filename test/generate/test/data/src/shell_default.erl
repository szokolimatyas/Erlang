-file("shell_default.erl", 1).

-module(shell_default).

-export([help/0, lc/1, c/1, c/2, c/3, nc/1, nl/1, l/1, i/0, pid/3, i/3, m/0, m/1, lm/0, mm/0, memory/0, memory/1, uptime/0, erlangrc/1, bi/1, regs/0, flush/0, pwd/0, ls/0, ls/1, cd/1, y/1, y/2, xm/1, bt/1, q/0, h/1, h/2, h/3, ht/1, ht/2, ht/3, hcb/1, hcb/2, hcb/3, ni/0, nregs/0]).

-export([ih/0, iv/0, im/0, ii/1, ii/2, iq/1, ini/1, ini/2, inq/1, ib/2, ib/3, ir/2, ir/3, ibd/2, ibe/2, iba/3, ibc/3, ic/0, ir/1, ir/0, il/0, ipb/0, ipb/1, iaa/1, iaa/2, ist/1, ia/1, ia/2, ia/3, ia/4, ip/0]).
...
help() ->
    ...
    format("h(Mod,Func,Arity) -- help about function with arity in modu" "le\n"),
    ...
    format("hcb(Mod,CB,Arity) -- help about callback with arity in modu" "le\n"),
    ...
    format("rp(Term)   -- display Term using the shell's record informa" "tion\n"),
